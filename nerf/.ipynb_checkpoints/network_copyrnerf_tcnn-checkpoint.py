...
from CopyRNeRF.encoder import Encoder_Tri_MLP_f
...
#         self.normalization = normalize_img
        ...
        msg_decoder = get_hidden_decoder_multi_views(num_bits=message_dim, redundancy=1,
                                                 num_blocks=8, input_ch=3, channels=64)
        self.msg_decoder = msg_decoder
        self.normalization = normalize_img
