        ...
        with torch.no_grad():
            ...
            for data in loader:    
                ...
                if self.local_rank == 0:
                    ...
                    # save image
                    save_path = os.path.join(self.workspace, 'validation', f'{name}', f'{name}_{self.local_step:04d}_rgb.png')
                    save_path_depth = os.path.join(self.workspace, 'validation', f'{name}', f'{name}_{self.local_step:04d}_depth.png')
